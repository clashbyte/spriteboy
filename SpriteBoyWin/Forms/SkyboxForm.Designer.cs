namespace SpriteBoy.Forms {
	partial class SkyboxForm {
		...
		private void InitializeComponent() {
			...
			this.saveButton = new SpriteBoy.Controls.NSIconicButton();
			...
			this.utilPanel.Controls.Add(this.saveButton);
			...
			this.saveButton.Corners.BottomLeft = true;
			this.saveButton.Corners.BottomRight = true;
			this.saveButton.Corners.TopLeft = true;
			this.saveButton.Corners.TopRight = true;
			this.saveButton.IconSize = new System.Drawing.Size(14, 14);
			this.saveButton.Large = false;
			this.saveButton.Location = new System.Drawing.Point(709, 1);
		...
		private Controls.NSIconicButton saveButton;
